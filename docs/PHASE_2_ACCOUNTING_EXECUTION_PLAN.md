...
| 0050 | P2-S7 | `accounting_report_indexes` | Two reporting indexes, created because `tests/performance/accounting-read-plans.test.ts` showed a single account's ledger page reading every line and every entry of the business. CANDIDATE: not frozen, not in the manifest. |

...
const ALLOWLIST = [
  'apps/api/src', 'apps/api/package.json', 'apps/api/tsconfig.json',
  'apps/web/src', 'apps/web/package.json', 'apps/web/next.config.mjs', 'apps/web/tsconfig.json',
  'apps/admin/src', 'apps/admin/package.json', 'apps/admin/next.config.mjs', 'apps/admin/tsconfig.json',
  'apps/android/settings.gradle.kts', 'apps/android/build.gradle.kts', 'apps/android/gradle.properties', 'apps/android/app',
  'packages/domain-core/src', 'packages/domain-core/package.json', 'packages/domain-core/tsconfig.json',
  'packages/shared-contracts/src', 'packages/shared-contracts/package.json', 'packages/shared-contracts/tsconfig.json',
  'packages/design-system/src', 'packages/design-system/package.json', 'packages/design-system/tsconfig.json',
  'infrastructure/database/migrations', 'infrastructure/database/MIGRATION_MANIFEST.json',
  'scripts', 'tests', 'docs',

...
export const checkSlugAvailability = (slug: string) =>
  apiFetch<SlugAvailabilityDto>(`${BFF}/onboarding/slug-availability?slug=${encodeURIComponent(slug)}`);
...
export const createBranch = (name: string) =>
  apiFetch<BranchDto>(`${BFF}/businesses/current/branches`, { method: 'POST', body: JSON.stringify({ name }) });
...
export const removeMember = (userId: string) =>
  apiFetch<void>(`${BFF}/businesses/current/members/${userId}`, { method: 'DELETE' });
export const suspendMember = (userId: string) =>
  apiFetch<void>(`${BFF}/businesses/current/members/${userId}/suspend`, { method: 'POST', body: '{}' });
export const reactivateMember = (userId: string) =>
  apiFetch<void>(`${BFF}/businesses/current/members/${userId}/reactivate`, { method: 'POST', body: '{}' });
...
export const resendInvitation = (id: string) =>
  apiFetch<void>(`${BFF}/businesses/current/invitations/${id}/resend`, { method: 'POST', body: '{}' });
export const cancelInvitation = (id: string) =>
  apiFetch<void>(`${BFF}/businesses/current/invitations/${id}`, { method: 'DELETE' });
...
export const deleteRole = (roleId: string) =>
  apiFetch<void>(`${BFF}/businesses/current/roles/${roleId}`, { method: 'DELETE' });
...
export const archiveProduct = (id: string) =>
  apiFetch<void>(`${BFF}/catalog/products/${id}`, { method: 'DELETE' });

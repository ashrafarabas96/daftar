...
const RESERVED = new Set([
  ...
  'mail', 'email', 'status', 'cdn', 'static', 'assets', 'media', 'img', 'images',
  'daftar', 'daftr', 'store', 'stores', 'shop', 'pos', 'pay', 'payments',
  'billing', 'auth', 'login', 'logout', 'signup', 'register', 'account',
  'security', 'legal', 'privacy', 'terms', 'about', 'contact', 'sales',
  'dev', 'staging', 'test', 'demo', 'beta', 'alpha', 'internal', 'infra',
  'ns1', 'ns2', 'ftp', 'smtp', 'imap', 'pop', 'webmail', 'portal', 'my',
  'null', 'undefined', 'root', 'system', 'super', 'superadmin',
]);

...
export const PERMISSIONS = [
  ...
  'member.view', 'member.invite', 'member.manage', 'member.suspend',
  'member.branch_scope.manage',
  'role.view', 'role.create', 'role.update', 'role.delete', 'role.assign',
  'catalog.view', 'catalog.create', 'catalog.update', 'catalog.archive',
  'category.manage',
  'media.manage',
...
export const SENSITIVE_PERMISSIONS = [
  'member.manage', 'member.suspend', 'member.branch_scope.manage',
